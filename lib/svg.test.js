...
describe('SVG', () => {
    ...
    describe('setShape method for Circle ', () => {
    ...
    describe('setShape method for Triangle', () => {
    ...
    describe('setShape method for Square', () => {
    ...
    // A test is created to check that setText() function returns a  text tag with the given text and color if the color is valid.
    describe('setText', () => {
    ...
    // A test is created to check whether an error is thrown when the length of logo text is more than 3.
    describe('textLength', () => {
    ...
    // A test is created to check whether setText() returns undefined when the color of logo text is invalid.
    describe('Invalid text color in setText', () => {
        it('should return undefined when the color of logo text is invalid', () => {
            const textColor = 'yell';
            const svg = new SVG('SVG', textColor, '', '');
            expect(svg.setText()).toBeUndefined();
        });
    });
});
